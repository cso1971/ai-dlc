...
RUN dotnet restore src/Services/Invoicing.Api/Invoicing.Api.csproj

# Copy source code
COPY src/Shared/ src/Shared/
COPY src/Services/Invoicing.Api/ src/Services/Invoicing.Api/

# Build and publish
RUN dotnet publish src/Services/Invoicing.Api/Invoicing.Api.csproj -c Release -o /app/publish --no-restore
