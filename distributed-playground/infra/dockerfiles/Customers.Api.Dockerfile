...
COPY src/Services/Customers.Api/ src/Services/Customers.Api/

# Build and publish
RUN dotnet publish src/Services/Customers.Api/Customers.Api.csproj -c Release -o /app/publish --no-restore
